...
int main() {
  ...
  // Área para entrada de dados
    ...
    super1 = (populacao1 + area1 + pib1 + turisticos1 + capita1 + (1 / densidade1));
    ...
    super2 = (populacao2 + area2 + pib2 + turisticos2 + capita2 + (1 / densidade2));
    printf("Super Poder: %.2f\n", super2);
...
// Exibição dos resultados das comparações
   ...
   printf("Pib: %d\nPontos Turiscos: %d\nDensidade Populacional: %d\n", (pib1 > pib2), (turisticos1 > turisticos2), (densidade1 < densidade2));
   printf("PIB per Capita: %d\nSuper Poder: %d\n", (capita1 > capita2), (super1 > super2));
